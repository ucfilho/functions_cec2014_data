...
def NamesFunctions():
    result ={ 'F1': 'elliptic','F2': 'bent_cigar','F3':'discus','F4':'Rosenbrock',
             'F5': 'Ackey','F6':'Weierstrass','F7':'Griewank','F8':'Rastrigin',
             'F9':'modified_Schwefel','F10':'Katsuura','F11':'happy_cat',
             'F12':'hgbat','F13':'expanded_Griewank','F14':'expanded_Scaffer'}
    return result
# F13: expanded Griewank   F14:  expanded Scaffer
